...
const COLUNAS: Coluna[] = [
  ...
  },
  {
    ...
    accessor: (i) => i.valores.previsto,
    render: (i) => formatMoeda(i.valores.previsto),
    align: "right",
  },
  {
    key: "empenhado",
    label: "Orçamento Atualizado",
    accessor: (i) => i.valores.empenhado,
    render: (i) => formatMoeda(i.valores.empenhado),
    align: "right",
  },
  {
    key: "liquidado",
    label: "Liquidado",
    accessor: (i) => i.valores.liquidado,
    render: (i) => formatMoeda(i.valores.liquidado),
    align: "right",
  },
